...
public class MatrixMultiplyTaskDTOTest {
    ...
    public void shouldMarshallAndUnMarshall() throws Exception {
        ...
        int magicNumber = 42;
        MatrixMultiplyTaskDTO dto = new MatrixMultiplyTaskDTO(A, A, magicNumber, magicNumber, magicNumber, ExperimentStrategy.MINMIN);
        ...
        assertEquals(ExperimentStrategy.MINMIN, unMarshalled.getExperimentStrategy());
